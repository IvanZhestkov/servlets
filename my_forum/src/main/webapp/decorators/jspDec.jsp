...
<html lang="ru">
    <head>
        ...
        <meta name="author" content="Ivan Zhestkov">
    ...
    <body class="blaboard">
        <div class="container-fluid">
            <header class="row blaboard__header blaboard__header_blue">
                <div class="col-xs-12">
                    <div class="clearfix">
                        <div class="float-xs-left"><a class="brand" href="main"><img class="brand__logo brand__logo_header" src="img/blab-logo.png" alt="Forum"></a>
                                                ...
                                                <c:forEach items="${user.notificationList}" var="notif">
                                                    <li>
                                                        <a class="notif__elem notif__elem_popup" href="topic?id=${notif.topic.topicId}#message${notif.message.messageId}">
                                                            ...
                                                            <span class="elem-desc">В ${notif.topic.topicName} участник ${notif.message.messageAuthor.username}</span>
                                                        </a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
            ...
            <div class="container">
                <footer class="clearfix footer">
                    <p class="float-xs-left footer__stat footer_class">Статистика сайта</p>
                    <div class="float-xs-right">
                        <ul class="counts">
                            <li class="counts__elem footer_class"><span class="counts__elem-name">Соообщений:</span><span class="counts__elem-count">${stats.forumMessagesNumber}</span></li>
                            <li class="counts__elem footer_class"><span class="counts__elem-name">Тем:</span><span class="counts__elem-count">${stats.topicsNumber}</span></li>
                            <li class="counts__elem footer_class"><span class="counts__elem-name">Пользователей:</span><span class="counts__elem-count">${stats.usersNumber}</span></li>
                        </ul>
                    </div>
                </footer>
                <div class="clearfix"></div>
