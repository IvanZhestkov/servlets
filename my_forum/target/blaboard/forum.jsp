                        ...
                        <c:if test="${section.lastTopic != null}">
                            <footer class="section__footer">
                                <div class="lastmessage"><img class="lastmessage__avatar" src="img/last_message_avatar.png">
                                    <div class="lastmessage__author"><a class="lastmessage__link" href="topic?id=${section.lastTopic.topicId}">${section.lastTopic.topicName}</a><a class="lastmessage__author-link" href="#author">Автор: ${section.lastTopic.topicAuthor.username}</a>
